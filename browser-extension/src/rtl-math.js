 ...
 *
 * Zero DOM access. Loaded BEFORE rtl-engine.js (manifest js order); exposed as
 * global `RTLXMath` (content scripts are classic scripts) and as
 * module.exports for the node unit tests. The engine degrades to a no-op when
 * this global is absent, so embedders (VS Code drivers) can adopt it later.
 * ========================================================================== */
(function (global) {
  "use strict";
