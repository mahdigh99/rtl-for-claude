 ...
 *
 * Zero DOM access. Injected into the Claude Code webview bundle BEFORE
 * driver.js (extension.js buildJs / apply-rtl.sh / apply-rtl.ps1 all prepend
 * it); exposed as global `RTLXMath` and as module.exports for the node unit
 * tests. The driver degrades to a no-op when this global is absent, so a
 * CSS-only patch still works.
 * ========================================================================== */
(function (global) {
  "use strict";
